...
1. **Carga y exploración de datos**  
   - Determinación de las variables más significativas para el análisis 
   - Depuración de la base de datos y manejo adecuado de valores faltantes o nulos. 

2. **Análisis exploratorio (EDA)**  
   - Representación gráfica de la relación entre variables como tipo de contrato, forma de pago, tiempo de permanencia y tipo de servicio en relación con la cancelación.

   - Detección de las variables que presentan mayor asociación o correlación con el churn.
...
4. **Modelado**  
   - **Modelo 1: Regresión Logística (df_lineal normalizado)**  
     - Accuracy: ~0.74  
     - Alto nivel de recall en clientes que cancelan, aunque con una precisión más baja.
   - **Modelo 2: Random Forest (df_arbol sin normalizar)**  
     - Accuracy: ~0.78  
     - Desempeño más equilibrado entre precisión y recall.
...
1. Fomentar la contratación a largo plazo mediante beneficios especiales en planes anuales o de dos años.
2. Mejorar la experiencia de los usuarios de fibra óptica, fortaleciendo el soporte técnico y garantizando mayor estabilidad del servicio.
3. Evaluar y optimizar las políticas de pago electrónico, priorizando la seguridad, la simplicidad y la claridad en la facturación.
4. Implementar estrategias de fidelización dirigidas a nuevos clientes durante los primeros meses del contrato.
